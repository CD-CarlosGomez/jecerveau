...
<head>
	...
	<!-- PRETTIFY --><!--script type="text/javascript" src="js/kickstart/prettify.js"></script-->
	
	<!--KICKSTART--><!--script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script-->
	<!--KICKSTART--><!--script type="text/javascript" src="js/kickstart/kickstart.js"></script-->
	<!--KICKSTART --><!--link rel="stylesheet" href="css/kickstart/kickstart.css" type="text/css" media="all" /-->
	<!--KICKSTART --><!--link rel="stylesheet" href="css/kickstart/style.css" type="text/css" media="all" /-->
	
	<!--JQUERY--><script src="//code.jquery.com/jquery-1.10.2.js"></script>
	<!--JQUERY-UI--><script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
	<!--JQUERY-UI--><link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
	...
	<!--BOOTSTRAP--><!--link href="css/bootstrap/bootstrap.min.css" rel="stylesheet"-->
</head>

<body>
	<div id="base_head">  
		<div id="menustop"><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></div></div>
<a href="#top-of-page" id="top-of-page" class="sr-only">Top of page</a>
