...
$s_ismanager = $row[24];
$s_add_type = $row[25];
$s_update_type = $row[26];
$s_delete_type = $row[27];
$s_add_area = $row[30];
$s_update_area = $row[31];
$s_add_location = $row[32];
$s_update_location = $row[33];
$s_add_position = $row[34];
$s_update_position = $row[35];
